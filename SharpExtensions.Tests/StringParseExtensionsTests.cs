...
namespace SharpExtensions.Tests
{
    ...
    public class StringParseExtensionsTests
    {
        ...
        public void ToShort()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => StringExtensions.ToShort(null, true));
        ...
        public void ToUShort()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => StringExtensions.ToUShort(null, true));
        ...
        public void ToInt()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => StringExtensions.ToInt(null, true));
        ...
        public void ToUInt()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => StringExtensions.ToUInt(null, true));
        ...
        public void ToLong()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => StringExtensions.ToLong(null, true));
        ...
        public void ToULong()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => StringExtensions.ToULong(null, true));
        ...
        public void ToFloat()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => StringExtensions.ToFloat(null, true));
        ...
        public void ToDouble()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => StringExtensions.ToDouble(null, true));
